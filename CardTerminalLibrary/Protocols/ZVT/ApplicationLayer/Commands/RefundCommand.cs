...
{
    public class RefundCommand : IPaymentCommand
    {
        ...
        public RefundCommand(IZvtTransport transport, ZVTCommandEnvironment commandEnvironment)
        {
            _environment = commandEnvironment;
            _transport = transport;
            _apdu = new RefundApdu();
        ...
        private void _commandTransmitter_StatusReceived(IntermediateStatusApduResponse apdu) {
			Status?.Invoke(CommandHelpers.ConvertIntermediateStatus(apdu));
		}
