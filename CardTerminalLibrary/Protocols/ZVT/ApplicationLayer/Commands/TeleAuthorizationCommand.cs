...
{
    public class TeleAuthorizationCommand : ITelePaymentCommand
    {
        ...
        /// Authorization APDU
        /// </summary>
        private TeleAuthorizationApdu _apdu;
        ...
        public TeleAuthorizationCommand(IZvtTransport transport, ZVTCommandEnvironment commandEnvironment)
        {
            _environment = commandEnvironment;
            _transport = transport;
            _apdu = new TeleAuthorizationApdu();
